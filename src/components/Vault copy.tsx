...
interface Props {
    onCancel?(): void
    data?: { bullets: number, money: number, bulletCost: number }
...
const Vault = ({ onCancel }: Props) => {
    ...
    return (
        <div
            ...
            // className="relative flex flex-col w-[300px] rounded-lg  bg-gray-50 overflow-hidden"
            style={{
        ...
        >
            ...
            {/* <div className='relative flex justify-between items-center !px-2 h-[28px]' >
                <span
